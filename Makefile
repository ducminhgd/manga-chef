...
LDFLAGS        := -ldflags="-s -w \
                    -X github.com/ducminhgd/manga-chef/internal/version.Version=$(VERSION) \
                    -X github.com/ducminhgd/manga-chef/internal/version.Commit=$(COMMIT) \
                    -X github.com/ducminhgd/manga-chef/internal/version.BuildDate=$(BUILD_DATE)"
