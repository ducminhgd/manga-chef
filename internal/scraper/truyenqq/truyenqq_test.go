...
func TestGetImageURLs_UsesDataOriginalAndResolvesAbsoluteURLs(t *testing.T) {
	html := `<!doctype html><html><body><div class="chapter_content"><div id="page_0" class="page-chapter"><img class="lazy" src="https://i216.truyenvua.com/236/1/0.jpg" data-original="https://i216.truyenvua.com/236/1/0.jpg" data-cdn="https://hinhtruyen.com/236/1/0.jpg" /></div><div id="page_1" class="page-chapter"><img class="lazy" data-original="https://i216.truyenvua.com/236/1/1.jpg" /></div><div id="banner" class="ad"><img src="https://ads.com/1.jpg" /></div></div></body></html>`
...
func TestFetchHTML_RetriesOn429AndSucceeds(t *testing.T) {
	html := `<!doctype html><html><body><div class="chapter_content"><div class="page-chapter"><img data-original="https://cdn.test/1.jpg"></div></body></html>`
	mockClient := scraper.NewMockHTTPClient(t)
	mockClient.On("Do", mock.Anything).Return(&http.Response{StatusCode: http.StatusTooManyRequests, Body: io.NopCloser(strings.NewReader("429"))}, nil).Once()
	mockClient.On("Do", mock.Anything).Return(&http.Response{StatusCode: http.StatusOK, Body: io.NopCloser(strings.NewReader(html))}, nil).Once()
	...
	assert.Equal(t, "https://cdn.test/1.jpg", urls[0])
}
